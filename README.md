...
# Data-Driven-PostgreSQL или "мягкая посадка" для данных, которые помогут бизнесу взлететь :airplane: 

_Этот репозиторий содержит решения практических кейсов по анализу данных в сфере авиаперевозок:_
